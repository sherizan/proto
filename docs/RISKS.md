...
| `AS-04` | App Store | Guideline 2.5.2 — Prototo App architecture (`expo-dev-client` + Metro bundle download via cloudflared tunnel) downloads & executes code at runtime. | `deferred` | `docs/prototo-app-store-plan.md`; `/Users/sherizan/.claude/plans/drifting-weaving-hammock.md` | Empirical probe paused. Audience pivot 2026-05-26: v1 ships via EAS Internal Distribution to designers + small teams, not App Store. The 2.5.2 risk is moot at this distribution channel. Re-engages when product validates and stakeholder reach (non-technical App Store users) becomes a priority — at which point the SDUI architecture from `docs/prototo-app-store-plan.md` §3 is the path. TestFlight `kVJN6n2A` external submission withdrawn 2026-05-26. |
